...
public class MinesFile {
    ...
    public static void setup() {
        file = new File(Bukkit.getServer().getPluginManager().getPlugin("WallStreet").getDataFolder(), "mines.yml");
    ...
    public static void setInt(String first, int second) {
        customFile.set(first, second);
    }
    public static void setDouble(String first, double second) {
        customFile.set(first, second);
    }
